...
def generate_random_string(token_length: int) -> str:
    random_string = ''.join(random.choices(string.ascii_letters + string.digits, k=token_length * 100))
...
def test_prefix_caching_send_all(all_prompts, num_prefix, num_samples_per_prefix, gen_len):
